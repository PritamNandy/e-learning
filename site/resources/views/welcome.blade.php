    ...
    <div class="row">
        <div class="col-md-3 p-2 ">
            <div class="card service-card text-center w-100">
                <div class="card-body">
                    <img class="service-card-logo " src="{{asset('images/knowledge.svg')}}" alt="Card image cap">
        ...
        <div class="col-md-3  p-2">
            <div class="card  service-card text-center w-100">
                <div class="card-body">
                    <img class="service-card-logo " src="{{asset('images/code.svg')}}" alt="Card image cap">
        ...
        <div class="col-md-3  p-2">
            <div class="card  service-card  text-center w-100">
                <div class="card-body">
                    <img class="service-card-logo " src="{{asset('images/graphic.svg')}}" alt="Card image cap">
        ...
        <div class="col-md-3 p-2 ">
            <div class="card service-card text-center w-100">
                <div class="card-body">
                    <img class="service-card-logo " src="{{asset('images/custom.svg')}}" alt="Card image cap">
...
<div class="container section-marginTop text-center">
    ...
    <div class="row">
        <div class="col-md-4 thumbnail-container">
                <img src="{{asset('images/android.jpg')}}" alt="Avatar" class="thumbnail-image ">
        ...
        <div class="col-md-4 thumbnail-container">
                <img src="{{asset('images/react.jpg')}}" alt="Avatar" class="thumbnail-image">
                <div class="thumbnail-middle">
                    <h1 class="thumbnail-title"> লারাভেল এবং প্রোজেক্ট </h1>
                    <h1 class="thumbnail-subtitle">আইটি কোর্স, প্রজেক্ট ভিত্তিক সোর্স কোড সহ আরো যে সকল সার্ভিস আমরা প্রদান করি </h1>
                    <button class="normal-btn btn">শুরু করুন</button>
        ...
        <div class="col-md-4 thumbnail-container ">
                <img src="{{asset('images/laravel.jpg')}}" alt="Avatar" class="thumbnail-image ">
                <div class="thumbnail-middle">
                    <h1 class="thumbnail-title"> লারাভেল এবং প্রোজেক্ট </h1>
                    <h1 class="thumbnail-subtitle">আইটি কোর্স, প্রজেক্ট ভিত্তিক সোর্স কোড সহ আরো যে সকল সার্ভিস আমরা প্রদান করি </h1>
                    <button class="normal-btn btn">শুরু করুন</button>
            ...
            <div id="one"  class="owl-carousel mb-4 owl-theme">
                <div class="item m-1 card">
                    <div class="text-center">
                        <img class="w-100" src="{{asset('images/poject.jpg')}}" alt="Card image cap">
                ...
                <div class="item m-1 card">
                    <div class="text-center">
                        <img class="" src="{{asset('images/poject.jpg')}}" alt="Card image cap">
                        <h5 class="service-card-title mt-4">আইটি কোর্স</h5>
                        <h6 class="service-card-subTitle p-0 m-0">মোবাইল  এবং ওয়েব এপ্লিকেশন ডেভেলপমেন্ট </h6>
                        <button class="normal-btn-outline mt-2 mb-4 btn">বিস্তারিত</button>
                    </div>
...
<div class="container section-marginTop text-center">
    ...
    <div class="row">
        <div class="col-md-4  p-2 ">
            <div class="card">
                <img class="w-100" src="{{asset('images/blog.jpg')}}" alt="Card image cap">
                <div class="w-100 p-4">
    ...
    <div class="row d-flex justify-content-center">
            <div class="col-md-6 text-center">
                ...
                <div class="item m-1 text-center ">
                        <img class="review-img text-center" src="{{asset('images/bill.jpg')}}" alt="Card image cap">
