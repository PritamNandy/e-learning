    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <p class="footer-text"><i class="fas fa-map-marker-alt"></i> বসুন্ধরা আবাসিক এলাকা, ঢাকা </p>
                <p class="footer-text"><i class="fas fa-phone"></i> ০১৭৭৭২৮২৭৭২ </p>
                <p class="footer-text"><i class="fas fa-envelope"></i> heyprasun@gmail.com</p>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
...
<div class="container-fluid bg-dark text-white m-0 text-center p-3">
    <p class="rights-text  my-2 ">সর্বস্বত্ব প্রসূন নন্দী প্রীতম  দ্বারা সংরক্ষিত; ২০১৯-২০২০ </p>
</div>
